...
var madlib = document.querySelector('#madlib'); 
 myForm.addEventListener('submit', function(event){
    ...
    if(noun1 && noun2 && noun3 && adj1 && adj2 && number){
        myText = ` • ${noun1}'s maganizine named Donald Trump the most <b><u>${adj1}</u><b> man alive`; 
        myText_two = `• Trump released his tax returns, paying more than $<b><u>${number}</u><b> in taxes!`; 
        myText_three = `• Donald Trump was recently spotted attending the <b><u>${noun3}</u><b> protest in ${noun2}`; 
